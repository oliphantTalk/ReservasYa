...
const elementos = [localParamsPanel, addUserPanel, addAirlinePanel, addAgencyPanel, addHotelPanel,
    addFlightPanel, addRoomPanel, addCarPanel, editUserPanel, editAirlinePanel, editAgencyPanel, editHotelPanel,
    editFlightPanel, editRoomPanel, editCarPanel, removeUserPanel,
    removeAirlinePanel, removeAgencyPanel, removeHotelPanel, removeFlightPanel, removeRoomPanel, removeCarPanel];
