...
function renderSystemError() {
    ...
    <div class="message-icon-container"><i class="message-icon eva-3-icon-info-circle"></i></div> 
    <div class="message-header"> 
      <h5 class="message-title eva-3-h5">¡Ups! Ha ocurrido un error en el sistema</h5> 
    </div> 
    <div class="message-body"> 
      <p class="message-text eva-3-p">Ha ocurrido un error en el sistema, por favor intente luego. </p> 
    </div> 
...
<div class="eva-3-row -no-gutter -eva-3-center">
    <div class="col -sm-12 -md-12">
        <div class="eva-3-row -no-gutter">
            ...
            <div class="col -md-3">
                <div class="fly-way-header">
                    <span class="fly-info -eva-3-hide-small">
                        <span class="fly-departure">
...
function renderItems(routes, referenceData) {
    let listBegin = `<div class="fly-detail-container"><ul>`;
        ...
        <div class="itinerary-container">
            <div class="eva-3-row -no-gutter  -eva-3-center">
                ...
                <div class="col -sm-2 -md-3">
                    <div class="eva-3-row -no-gutter">
                        <div class="col -sm-12">
                            <div class="-eva-3-hide-medium -eva-3-hide-large">
                ...
                <div class="fare-text-wrapper">
                    ...
                    <div class="fare-price">
                        <em>
                            ...
                            <span class="current-price">${cluster.priceDetail.mainFare.amount}</span>
                        </em>
                    </div>
                </div>
            </div>
                ...
                <div class="fare-button-wrapper">
                    <div class="button-container">
                        <a class="eva-3-btn -primary -md">
                            <em class="btn-text">Seleccionar</em>
                        </a>
                    </div>
                </div>
            </div>
...
function renderMarkup(json, isReturnNecessary) {
 ...
 /*   ///////////////////////////////////////////////
    ...
    localStorage.setItem('jsonClusters', JSON.stringify(json));
    // Retrieve the object from storage
    const retrievedJson = localStorage.getItem('jsonClusters');
    console.log('retrievedObject: ', JSON.parse(retrievedJson));
    ////////////////////////////////////////////*/
    ...
    else if(Object.keys(json.clusters).length == 0){
        divClusters.innerHTML = renderMessageNoFly();
    }
    else if (json.status >= 500){
        divClusters.innerHTML = renderSystemError();
    } 
    else
    {
        let idIndex = 0;
        ...
        for (let cluster of json.clusters ) {
            ...
            htmlForCluster += renderContainerBegin();
                ...
                htmlForCluster += renderClusterBodyBegin();
                    ...
                    htmlForCluster += renderItems(cluster.routeChoices[0].routes, referenceData);
                    // fin cluster ida //
                    // comienzo cluster vuelta //
                    if(isReturnNecessary){
                        htmlForCluster += renderHeaderReturn(referenceData);
                        htmlForCluster += renderItems(cluster.routeChoices[1].routes, referenceData);
                    }
                    // end cluster vuelta //
                // end clusterBody 
